...
class PGConnecter {
    constructor(options) {
        if(options && options.pg && options.pg.connectionString) {
          var pg = require('pg-connection-string').parse(options.pg.connectionString);
          options.pg = {...pg, ...options.pg};
          delete options.pg.connectionString;
        }
